 ...
 * to 1 byte
 */
BusIO_Register::BusIO_Register(I2CDevice *i2cdevice, uint16_t reg_addr, uint8_t width, uint8_t byteorder, uint8_t address_width) {
 ...
 *    @return True on successful write (only really useful for I2C)
 */
